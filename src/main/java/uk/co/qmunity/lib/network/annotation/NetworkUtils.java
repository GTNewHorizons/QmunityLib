...
public class NetworkUtils {
    ...
    /*
     * private static Map<Class, List<Field>> extraMarkedFields = new HashMap<Class, List<Field>>(); public static void
     * addExtraMarkedField(Class clazz, Field field){ List<Field> markedFields = extraMarkedFields.get(clazz);
